...
/**
 * This class is used to handle simple sprites.
 */
...
public:
	...
	{
		return myBitmap.bmWidth;
	}

    virtual int GetHeight() const 
	{
		return myBitmap.bmHeight;
	}

    virtual int GetFrameCropX() const 
	{
		return 0;
	}

    virtual int GetFrameCropY() const
	{
		return 0;
	}
